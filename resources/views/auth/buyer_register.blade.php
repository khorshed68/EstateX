...
<head>
    ...
    <title>EstateX - Create Buyer Account</title>
...
<body class="font-sans min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md my-8">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <p class="text-slate-400 text-sm mt-1">Start your journey to find your dream property</p>
        </div>
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-3xl p-8 glowing-card backdrop-blur-md">
            <div class="mb-6">
                ...
                <p class="text-xs text-slate-500 mt-1">Register as a buyer to start scheduling visits and reserving listings.</p>
            </div>
            ...
            <form action="{{ route('buyer.register.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="fullname" name="fullname" value="{{ old('fullname') }}" required placeholder="John Doe" 
                               class="w-full bg-slate-950 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition duration-200">
                    </div>
                    @error('fullname')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required placeholder="john@example.com" autocomplete="off"
                               class="w-full bg-slate-950 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition duration-200">
                    </div>
                    @error('email')
                        <span class="text-red-400 text-[11px] mt-1 block">{{ $message }}</span>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="file" id="profile_image" name="profile_image" accept="image/*"
                               class="w-full bg-slate-950 border border-slate-800 rounded-xl py-2 pl-10 pr-4 text-xs text-slate-400 file:mr-4 file:py-2 file:px-3 file:rounded-lg file:border-0 file:text-[10px] file:font-bold file:bg-emerald-500/10 file:text-emerald-400 hover:file:bg-emerald-500/20 file:cursor-pointer transition duration-200">
                    </div>
                    @error('profile_image')
                        <span class="text-red-400 text-[11px] mt-1 block">{{ $message }}</span>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" required placeholder="Repeat password" autocomplete="new-password"
                               class="w-full bg-slate-950 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition duration-200">
                    </div>
                </div>
                ...
                <!-- Register Button -->
                <button type="submit" 
                        class="w-full py-3.5 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white text-sm font-bold tracking-wide rounded-xl shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/20 active:scale-[0.98] transition duration-200 mt-4">
                    Create Account
                </button>
            </form>
            ...
            <div class="mt-6 text-center text-xs text-slate-500">
                ...
                <a href="{{ route('buyer.login') }}" class="text-emerald-400 hover:text-emerald-300 font-bold hover:underline transition duration-200">Log In Here</a>
            </div>
        </div>
    </div>
